...
const Servers = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        db_host: 'localhost',
        db_port: 3306,
        db_user: brand.defaultDbUser,
        db_password: '',
        nexcrm_backend_path: brand.defaultBackendPath,
    ...
    const handleEdit = (server) => {
        ...
        setFormData({
            ...
            db_user: server.db_user || brand.defaultDbUser,
            db_password: '',
            nexcrm_backend_path: server.nexcrm_backend_path || brand.defaultBackendPath,
